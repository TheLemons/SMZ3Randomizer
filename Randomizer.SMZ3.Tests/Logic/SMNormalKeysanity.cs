...
namespace Randomizer.SMZ3.Tests.Logic {
    ...
    public class SMNormalKeysanity : SMNormal {
        ...
        protected override List<Case> MaridiaOuter => new() {
            ...
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Sword.Cape.Lamp.KeyCT(2).CardMaridiaL1.CardMaridiaL2.Morph.Bombs),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Sword.Cape.Lamp.KeyCT(2).CardMaridiaL1.CardMaridiaL2.Morph.PowerBomb),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Sword.Cape.Lamp.KeyCT(2).CardMaridiaL1.CardMaridiaL2.ScrewAttack),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.MasterSword.Lamp.KeyCT(2).CardMaridiaL1.CardMaridiaL2.Morph.Bombs),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.MasterSword.Lamp.KeyCT(2).CardMaridiaL1.CardMaridiaL2.Morph.PowerBomb),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.MasterSword.Lamp.KeyCT(2).CardMaridiaL1.CardMaridiaL2.ScrewAttack),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Hammer.Glove.CardMaridiaL1.CardMaridiaL2.Morph.Bombs),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Hammer.Glove.CardMaridiaL1.CardMaridiaL2.Morph.PowerBomb),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Hammer.Glove.CardMaridiaL1.CardMaridiaL2.ScrewAttack),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Mitt.CardMaridiaL1.CardMaridiaL2.Morph.Bombs),
            CaseWith(x => x.Gravity.MoonPearl.Flippers.Morph.Mitt.CardMaridiaL1.CardMaridiaL2.Morph.PowerBomb),
        ...
        protected override List<Case> NorfairUpperCrocomire => new() {
            CaseWith(x => x.Morph.PowerBomb.Super.Varia.CardNorfairL1.SpeedBooster),
        ...
        protected override List<Case> NorfairLowerEast => new() {
            ...
            CaseWith(x => x.Varia.CardLowerNorfairL1.SpeedBooster.Super.Wave.Morph.PowerBomb.SpaceJump.Gravity),
