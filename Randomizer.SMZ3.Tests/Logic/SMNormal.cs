...
namespace Randomizer.SMZ3.Tests.Logic {
    ...
    public class SMNormal : LogicCases {
        ...
        protected override List<Case> NorfairUpperCrocomire => new() {
            CaseWith(x => x.Varia.Morph.PowerBomb.Super.SpeedBooster),
            ...
            CaseWith(x => x.Varia.Flute.Super.SpaceJump.Morph.Gravity.Wave),
            CaseWith(x => x.Varia.Flute.Super.HiJump.Morph.Gravity.Wave),
            CaseWith(x => x.Varia.Glove.Lamp.SpeedBooster.Wave),
            CaseWith(x => x.Varia.Glove.Lamp.Super.SpaceJump.Morph.Gravity.Wave),
            CaseWith(x => x.Varia.Glove.Lamp.Super.HiJump.Morph.Gravity.Wave),
        ...
        protected override List<Case> CheckerboardCave => new() {
            ...
            CaseWith(x => x.Mirror.Glove.Varia.Super.Gravity.SpaceJump.Morph.PowerBomb),
        };
        ...
        protected override List<Case> WetlandsDam => CaseWithNothing;
        ...
        protected override List<Case> PyramidFairy => new() {
            ...
            CaseWith(x => x.MoonPearl.Sword.Cape.Lamp.KeyCT(2).Mitt.Mirror),
            ...
            CaseWith(x => x.MoonPearl.MasterSword.Lamp.KeyCT(2).Mitt.Mirror),
        ...
        protected override List<Case> MiseryMire => new() {
            ...
            CaseWith(x => x.Varia.Super.Gravity.SpaceJump.Morph.PowerBomb.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Varia.Super.Gravity.SpaceJump.Morph.PowerBomb.Ether.Sword.MoonPearl.Hookshot),
        };
