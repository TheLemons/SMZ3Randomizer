...
namespace Randomizer.SMZ3.Tests.Logic {
    ...
    public class SMHard : SMNormal {
        ...
        protected override List<Case> MaridiaOuter => new() {
            ...
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Sword.Cape.Lamp.KeyCT(2).Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Sword.Cape.Lamp.KeyCT(2).PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Sword.Cape.Lamp.KeyCT(2).Super.SpringBall),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Sword.Cape.Lamp.KeyCT(2).Super.Ice),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.MasterSword.Lamp.KeyCT(2).Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.MasterSword.Lamp.KeyCT(2).PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.MasterSword.Lamp.KeyCT(2).Super.SpringBall),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.MasterSword.Lamp.KeyCT(2).Super.Ice),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Hammer.Glove.Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Hammer.Glove.PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Hammer.Glove.Super.SpringBall),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Hammer.Glove.Super.Ice),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Mitt.Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Mitt.PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Mitt.Super.SpringBall),
            CaseWith(x => x.MoonPearl.Flippers.Morph.HiJump.Mitt.Super.Ice),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Sword.Cape.Lamp.KeyCT(2).Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Sword.Cape.Lamp.KeyCT(2).PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Sword.Cape.Lamp.KeyCT(2).ScrewAttack),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Sword.Cape.Lamp.KeyCT(2).Super),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.MasterSword.Lamp.KeyCT(2).Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.MasterSword.Lamp.KeyCT(2).PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.MasterSword.Lamp.KeyCT(2).ScrewAttack),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.MasterSword.Lamp.KeyCT(2).Super),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Hammer.Glove.Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Hammer.Glove.PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Hammer.Glove.ScrewAttack),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Hammer.Glove.Super),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Mitt.Bombs),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Mitt.PowerBomb),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Mitt.ScrewAttack),
            CaseWith(x => x.MoonPearl.Flippers.Morph.Gravity.Mitt.Super),
        };
        ...
        protected override List<Case> NorfairUpperCrocomire => new() {
            ...
            CaseWith(x => x.Flute.Mitt.ScrewAttack.SpaceJump.Varia.Super.ETank(2)),
        };
        ...
        protected override List<Case> DarkWorldMire => new() {
            ...
            CaseWith(x => x.Varia.Super.Bombs.Gravity.Morph.PowerBomb),
            CaseWith(x => x.Varia.Super.HiJump.Morph.PowerBomb),
            CaseWith(x => x.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb),
            CaseWith(x => x.Varia.Super.SpringBall.Gravity.Morph.PowerBomb),
        ...
        protected override List<Case> DesertPalace => new() {
            ...
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb),
            CaseWith(x => x.Mirror.Varia.Super.Bombs.Gravity.Morph.PowerBomb),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb),
            CaseWith(x => x.Mirror.Varia.Super.SpringBall.Gravity.Morph.PowerBomb),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb),
        };
        ...
        protected override List<Case> DesertPalaceLanmolas => new() {
            ...
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Firerod),
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Sword),
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Hammer),
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Bow),
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Icerod),
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Byrna),
            CaseWith(x => x.Mirror.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Somaria),
            CaseWith(x => x.Mirror.Varia.Super.Morph.Bombs.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Firerod),
            CaseWith(x => x.Mirror.Varia.Super.Morph.Bombs.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Sword),
            CaseWith(x => x.Mirror.Varia.Super.Morph.Bombs.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Hammer),
            CaseWith(x => x.Mirror.Varia.Super.Morph.Bombs.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Bow),
            CaseWith(x => x.Mirror.Varia.Super.Morph.Bombs.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Icerod),
            CaseWith(x => x.Mirror.Varia.Super.Morph.Bombs.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Byrna),
            CaseWith(x => x.Mirror.Varia.Super.Morph.Bombs.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Somaria),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb.BigKeyDP.KeyDP(1).Firerod),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Sword),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Hammer),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Bow),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Icerod),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Byrna),
            CaseWith(x => x.Mirror.Varia.Super.HiJump.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Somaria),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Firerod),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Sword),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Hammer),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Bow),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Icerod),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Byrna),
            CaseWith(x => x.Mirror.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Somaria),
            CaseWith(x => x.Mirror.Varia.Super.Morph.SpringBall.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Firerod),
            CaseWith(x => x.Mirror.Varia.Super.Morph.SpringBall.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Sword),
            CaseWith(x => x.Mirror.Varia.Super.Morph.SpringBall.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Hammer),
            CaseWith(x => x.Mirror.Varia.Super.Morph.SpringBall.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Bow),
            CaseWith(x => x.Mirror.Varia.Super.Morph.SpringBall.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Icerod),
            CaseWith(x => x.Mirror.Varia.Super.Morph.SpringBall.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Byrna),
            CaseWith(x => x.Mirror.Varia.Super.Morph.SpringBall.Gravity.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Somaria),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Firerod),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Sword),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Hammer),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Bow),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Icerod),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Byrna),
            CaseWith(x => x.Mirror.Varia.Super.Ice.Gravity.Morph.PowerBomb.BigKeyDP.KeyDP(1).Lamp.Somaria),
        };
        ...
        protected override List<Case> MiseryMire => new() {
            CaseWith(x => x.Flute.Mitt.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Flute.Mitt.Ether.Sword.MoonPearl.Hookshot),
            CaseWith(x => x.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Varia.Super.SpaceJump.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Hookshot),
            CaseWith(x => x.Varia.Super.Bombs.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Varia.Super.Bombs.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Hookshot),
            CaseWith(x => x.Varia.Super.HiJump.Morph.PowerBomb.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Varia.Super.HiJump.Morph.PowerBomb.Ether.Sword.MoonPearl.Hookshot),
            CaseWith(x => x.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Varia.Super.SpeedBooster.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Hookshot),
            CaseWith(x => x.Varia.Super.SpringBall.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Varia.Super.SpringBall.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Hookshot),
            CaseWith(x => x.Varia.Super.Ice.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Boots),
            CaseWith(x => x.Varia.Super.Ice.Gravity.Morph.PowerBomb.Ether.Sword.MoonPearl.Hookshot),
        };
